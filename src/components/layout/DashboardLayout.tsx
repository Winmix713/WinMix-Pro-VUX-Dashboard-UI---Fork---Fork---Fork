...
const DashboardLayout = () => {
  return <div className="bg-[#0A0A0A] text-white font-sans min-h-screen flex overflow-hidden selection:bg-[#BEF264] selection:text-black antialiased relative">
      {/* --- GLOBAL ATMOSPHERE LAYER --- */}
      {/* Static Noise Texture for "Film Grain" look */}
      <div className="fixed inset-0 pointer-events-none z-0 opacity-[0.03] mix-blend-soft-light" style={{
